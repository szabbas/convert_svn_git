...
public class IAssignRouteBOImpl implements IAssignRouteBO {
	...
	@Override
	public long getAllEmployeesCountByDateByVendorId(Date fromDate,
			Date toDate, int branchId, String tripType, int vendorId) {
		// TODO Auto-generated method stub
	...
	@Override
	public long getAllEmployeesCountByShiftByVendorId(Date fromDate,
			Date toDate, int branchId, String tripType, Time shiftTime,
			int vendorId) {
		// TODO Auto-generated method stub
		return iAssignRouteDAO.getAllEmployeesCountByShiftByVendorId(fromDate, toDate, branchId, tripType, shiftTime, vendorId);
	}
