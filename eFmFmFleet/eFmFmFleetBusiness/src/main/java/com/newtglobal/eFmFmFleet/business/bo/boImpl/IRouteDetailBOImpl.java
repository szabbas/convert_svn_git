...
public class IRouteDetailBOImpl implements IRouteDetailBO {
	...
	@Override
	public List<EFmFmRouteAreaMappingPO> getRouteAreaIdFromAreaNameAndZoneName(
			String areaName, int branchId, String zoneName) {
		// TODO Auto-generated method stub
		return iRouteDetailDAO.getRouteAreaIdFromAreaNameAndZoneName(areaName, branchId, zoneName);
	}
