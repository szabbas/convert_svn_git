...
public class CabRequestDAOImpl implements ICabRequestDAO{
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public List<EFmFmTripTimingMasterPO> getShiftTimeDetailFromShiftTimeAndTripType(int branchId,Time shiftTime,String tripType) {
		List <EFmFmTripTimingMasterPO> shiftTimeDetail = new ArrayList<EFmFmTripTimingMasterPO>();		
		Query query=entityManager.createQuery("SELECT b FROM EFmFmTripTimingMasterPO b JOIN b.eFmFmClientBranchPO  c where c.branchId='"+branchId+"' AND b.tripType='"+tripType+"' AND b.shiftTime='"+shiftTime+"' AND b.isActive='Y' ");
	...
	@Override
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public List<EFmFmTripTimingMasterPO> getParticularShiftTimeDetailByTripType(int branchId,Time shiftTime,String tripType) {
		List <EFmFmTripTimingMasterPO> shiftTimeDetail = new ArrayList<EFmFmTripTimingMasterPO>();		
		Query query=entityManager.createQuery("SELECT b FROM EFmFmTripTimingMasterPO b JOIN b.eFmFmClientBranchPO  c where c.branchId='"+branchId+"' AND b.shiftTime='"+shiftTime+"' AND b.tripType='"+tripType+"' AND b.isActive='Y' ");
		shiftTimeDetail=query.getResultList();		
		return shiftTimeDetail;
	}
		...
		public long getAllActiveDropOrPickupRequestCounterForGuest(int branchId) {
		  ...
		  @Override
			...
			public List<EFmFmEmployeeTravelRequestPO> listOfTravelRequestByShiftTripType(int branchId,Time shiftTime,String tripType,String todaysDate) {		
				List <EFmFmEmployeeTravelRequestPO> employeeTravelRequestPO = new ArrayList<EFmFmEmployeeTravelRequestPO>();				
				Query query=entityManager.createQuery("SELECT b FROM EFmFmEmployeeTravelRequestPO b JOIN b.efmFmUserMaster u JOIN u.eFmFmClientBranchPO c JOIN b.eFmFmRouteAreaMapping a JOIN a.eFmFmZoneMaster z where c.branchId='"+branchId+"' AND b.approveStatus='Y' AND b.readFlg='Y' AND DATE(b.requestDate)='"+todaysDate+"' AND b.shiftTime='"+shiftTime+"' AND u.latitudeLongitude is not null  AND b.tripType='"+tripType+"' ORDER BY requestDate,z.zoneName,pickUpTime ASC");
				employeeTravelRequestPO=query.getResultList();		
				return employeeTravelRequestPO;
			}
		  @Override
		  ...
		  @Override
			...
			public List<EFmFmEmployeeTravelRequestPO> getparticularRequestwithShiftTime(EFmFmEmployeeTravelRequestPO eFmFmEmployeeTravelRequestPO) {
				List <EFmFmEmployeeTravelRequestPO> employeeTravelRequestPO = new ArrayList<EFmFmEmployeeTravelRequestPO>();
				Query query=entityManager.createQuery("SELECT b FROM EFmFmEmployeeTravelRequestPO b JOIN b.eFmFmEmployeeRequestMaster r JOIN r.efmFmUserMaster u JOIN u.eFmFmClientBranchPO c where b.requestId='"+eFmFmEmployeeTravelRequestPO.getRequestId()+"' AND c.branchId='"+eFmFmEmployeeTravelRequestPO.getBranchId()+"' ");
				employeeTravelRequestPO=query.getResultList();		
				return employeeTravelRequestPO;
			}
			 ...
			 @Override
				@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
				 public List<EFmFmAssignRoutePO> getCreatedAssignRoute(int branchId,String reqType,Time shiftTime) {
				  List <EFmFmAssignRoutePO> assignVehicleDetail = new ArrayList<EFmFmAssignRoutePO>();
				  Query query=entityManager.createQuery("SELECT b FROM EFmFmAssignRoutePO b JOIN b.eFmFmClientBranchPO c where b.vehicleStatus='A' AND b.tripStatus='allocated' AND c.branchId ='"+branchId+"' AND b.tripType='"+reqType+"' AND b.shiftTime='"+shiftTime+"'  ORDER BY b.assignRouteId DESC ");  
				  assignVehicleDetail=query.getResultList();  
				  return assignVehicleDetail;
				 }
			...
			public List<EFmFmEmployeeTripDetailPO> getDropTripByAlgoRouteSortedEmployees(int assignRouteId) {
				List <EFmFmEmployeeTripDetailPO> tripemployees = new ArrayList<EFmFmEmployeeTripDetailPO>();
				Query query=entityManager.createQuery("SELECT b FROM EFmFmEmployeeTripDetailPO b JOIN b.eFmFmEmployeeTravelRequest t JOIN t.efmFmUserMaster u JOIN b.efmFmAssignRoute d where d.assignRouteId='"+assignRouteId+"'");		
				tripemployees=query.getResultList();				
				return tripemployees;
			}
			...
			public void deleteParticularTripDetailByRouteId(int routeId) {
				List <EFmFmEmployeeTripDetailPO> employeeTravelRequestPO = new ArrayList<EFmFmEmployeeTripDetailPO>();
				Query query = entityManager.createQuery("SELECT b FROM EFmFmEmployeeTripDetailPO b JOIN b.efmFmAssignRoute a  where a.assignRouteId ='"+ routeId+"'");	
				employeeTravelRequestPO=query.getResultList();						
			...
			public List<EFmFmEmployeeTravelRequestPO> getparticularEmployeeRequest(String todaysDate,String employeeId, String tripType,int branchId,String shiftTime) {			
				List <EFmFmEmployeeTravelRequestPO> employeeTravelRequestPO = new ArrayList<EFmFmEmployeeTravelRequestPO>();
				Query query=entityManager.createQuery("SELECT b FROM EFmFmEmployeeTravelRequestPO b JOIN b.eFmFmEmployeeRequestMaster r JOIN r.efmFmUserMaster u JOIN u.eFmFmClientBranchPO c where u.employeeId='"+employeeId+"' AND c.branchId='"+branchId+"' AND b.shiftTime='"+shiftTime+"' AND b.tripType='"+tripType+"' AND DATE(b.requestDate)='"+todaysDate+"' order by b.requestId desc");
				employeeTravelRequestPO=query.getResultList();		
				return employeeTravelRequestPO;
			}
			@Override
			...
			public EFmFmEmployeeTripDetailPO ParticularTripDetail(int empTripId) {
				...
				Query query = entityManager.createQuery("SELECT b EFmFmEmployeeTripDetailPO b where b.empTripId = '"+ empTripId+ "' ");
			...
			public List<EFmFmEmployeeTripDetailPO> getparticularEmployeeTripDetails(String todaysDate,String employeeId, String tripType,int branchId,String shiftTime) {			
				List <EFmFmEmployeeTripDetailPO> employeeTravelRequestPO = new ArrayList<EFmFmEmployeeTripDetailPO>();
				Query query=entityManager.createQuery("SELECT r FROM EFmFmEmployeeTripDetailPO r JOIN r.eFmFmEmployeeTravelRequest b JOIN b.efmFmUserMaster u JOIN u.eFmFmClientBranchPO c where u.employeeId='"+employeeId+"' AND c.branchId='"+branchId+"' AND b.shiftTime='"+shiftTime+"' AND b.tripType='"+tripType+"' AND DATE(b.requestDate)='"+todaysDate+"'");
				employeeTravelRequestPO=query.getResultList();		
				return employeeTravelRequestPO;
			}
			@Override
