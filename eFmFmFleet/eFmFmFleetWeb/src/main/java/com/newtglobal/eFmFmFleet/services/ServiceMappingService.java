	...
	public Response manualBucketClose(EFmFmAssignRoutePO assignRoutePO) throws ParseException{					
		...
		assignRoutes.get(0).setTripUpdateTime(new Date());
		 if(assignRoutes.get(0).getTripType().equalsIgnoreCase("PICKUP")){
			...
			if(assignRoutes.get(0).getEfmFmVehicleCheckIn().getEfmFmVehicleMaster().getAvailableSeat()==0 && tripEmployees.get(0).geteFmFmEmployeeTravelRequest().getEfmFmUserMaster().getGender().equalsIgnoreCase("Female") &&(tripEmployees.get(0).geteFmFmEmployeeTravelRequest().getShiftTime().getHours() >=20 || tripEmployees.get(0).geteFmFmEmployeeTravelRequest().getShiftTime().getHours() ==0 || tripEmployees.get(0).geteFmFmEmployeeTravelRequest().getShiftTime().getHours() <=7)){
