               ...
               <div class = "wrapper1">             
                ...
                <tabset class="tabset subTab_invoice">
                  ...
                  <tab ng-click = "">
                    ...
                    <!-- THIRD TAB -->
                  <tab ng-click = "getContractDetail()">
                    <tab-heading ng-click = "vehicleTab()">Contract Detail</tab-heading>
                      <div class = 'invoiceTabContent'>
                      <div class = "firstRowInvoce ">
                          <div class = "row">
                              ...
                              <div class = "col-md-2">
                        		<input class = "form-control" ng-model = "efmfilter.contractDetail" placeholder = "Filter Contracts Detail">
                        	</div>
                          </div>
                      </div>
