...
<!--                            <div class = "col-md-3"></div>-->
                            ...
                            <table class = "reportTable reportTable_km table table-responsive container-fluid" >
                                <thead class ="tableHeading">
                                    <tr>
                                        <th colspan = "14" class ="tableHeadding_km" style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                            <div class = 'row'>
                                                <div class = 'col-md-4'>
                                                </div>
                                                <div class = 'col-md-4'>
                                                    Trip Sheet Report </br>Date : 
                                                <span>{{searchFromDateTS | date : 'longDate'}} - {{searchToDateTS | date : 'longDate'}}</span>
                                                </div>
                                                <div class = 'col-md-4'>
                                ...
                                <tbody>
		                           <tr ng-repeat-start="date in tripSheetData" class = "visibleRow_reportTripSheet">
                                       <td colspan="14">{{date.tripAssignDate}}</td>
                                   </tr> 
		                            <tr ng-repeat-end="" 
                        ...
                        <!-- Table-->                           
                           <div id="exportableOnTime" class = "col-md-12 col-xs-12 tableWrapper_report">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid" ng-show="gotOTResult">
                                    <thead class ="tableHeading">
                                        <tr>                                            
                                            <th colspan = '11' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                                <div class = "row">
                                                    <div class = 'col-md-4'>
                                                    </div>
                                                    <div class = 'col-md-4'>
                                                        OT{{OT}} Reoprt for {{headingVendorsOT}} | {{headingShiftOT}}</br>
                                                        <span>{{searchFromDateOT | date : 'longDate'}} - {{searchToDateOT | date : 'longDate'}}</span>
                                                    </div>
                                                    <div class = 'col-md-4'>
                                                        <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" 
                                                                ng-click = "saveInExcel()">
                                        ...
                                        <tr>
                                          ...
                                          <th colspan = '7' class = 'monthlyDailyCol' style = "background-color:#eb9316;">Monthly and Daily OT{{OT}}</th>
                                        </tr>
                                        <tr>
                        ...
                        <!-- Table-->                           
                           <div class = "col-md-12 col-xs-12 tableWrapper_report">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid" ng-show="gotSUResult">
                                    <thead class ="tableHeading">
                                        <tr>                                            
                                            <th colspan = '10' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                                <div class = "row">
                                                    <div class = "col-md-4">
                                                    </div>
                                                    <div class = "col-md-4">
                                                        {{SUresultTripType}}  - {{SUReportTitle}} 
                                                        </br> <span>{{fromDate | date : 'longDate'}} - {{toDate | date : 'longDate'}}</span>
                                                    </div>
                                                    <div class = "col-md-4">
                                                        <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" ng-click = "saveInExcel()">
...
<!--                                     <option value="">-- Select Shift --</option>-->
                        ...
                        <!-- Table-->                           
                           <div id = "exportableNoShow" class = "col-md-12 col-xs-12 tableWrapper_report">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid" ng-show="gotNSResult">
                                    <thead class ="tableHeading">
                                        <tr>
                                            <th colspan = '5' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                                <div class = "row">
                                                    <div class = "col-md-4"></div>
                                                    <div class = "col-md-4">
                                        ...
                                        <tr>
                                          <th ng-if = 'NSresultShift == "All Shifts" && !searchNSByEmployeeId'>Date</th>
                                          <th ng-if = 'NSresultShift == "By Shifts" && !searchNSByEmployeeId'>Shift Time</th>
                                          <th ng-if = 'searchNSByEmployeeId'>Date</th>
                                          <th ng-if = 'searchNSByEmployeeId'>Shift Time</th>
                                          <th>{{NStotalShift}}</th>
                                          <th>{{NSTripType}}</th>
                                          <th ng-if = noShowResult != '0' style = 'background-color: rgba(107, 228, 12, 0.37);' >No-Show</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                       <tr class = "reportResultTable tabletdCenter" ng-repeat="NS in noShowReportData | filter:efmfilter.filterNoShowData">
                                           <td ng-if = 'NSresultShift == "All Shifts" && !searchNSByEmployeeId'>{{NS.tripDates}}</td>
                                           <td ng-if = 'NSresultShift == "By Shifts" && !searchNSByEmployeeId'>{{NS.tripDates}}</td> 
                                           <td ng-if = 'searchNSByEmployeeId'>{{NS.tripDates}}</td>
                                           <td ng-if = 'searchNSByEmployeeId'>7:00**</td>
                                           
                                           <td>{{NS.totalUsedVehicles}}</td>
                                           <td>{{NS.totalEmployeesPickedDropCount}}</td>
                                           <td ng-if = noShowResult != '0' class = 'highlightedColumn_Report' >{{NS.totalEmployeesNoShowCount}}</td>
                                       </tr> 
                                     </tbody>                                
                            </table> 
                          </div> 
...
<!--                               <div class = "KmSummary row" ng-repeat = "reportSum_vendor in reportsSum">-->
                               <table class = "reportTable reportTable_km table table-responsive container-fluid" ng-show = "reportsSum.length>0">
                                    <thead class ="tableHeading">
                                        <tr>
                                            <th colspan = "8" class ="tableHeadding_km" style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                                <div class = "row">
                                                    <div class = "col-md-4">
                                                    </div>
                                                    <div class = "col-md-4">
                                                        {{headingReportTypeKM}} Report for {{reportSelectionKM}} </br>Date : <span>{{searchFromDateKM | date : 'longDate'}} - {{searchToDateKM | date : 'longDate'}}</span>
                                                    </div>
                                                    <div class = "col-md-4">
                                                        <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" ng-click = "saveInExcel()">
                                                            <i class = "icon-download-alt"></i><span class = "marginLeft5">Excel</span>
        ...
        <!--                                    <tr col-span = "3" class ="tableHeadding_km">Kilometer Report</tr>-->
                                            <tr>
                                                ...
                                                <div class ="row">
                                                    <div class = "col-md-4"></div>
                                                    <div class = "col-md-4">
                                                        {{headingReportTypeKM}} Report for {{reportSelectionKM}} </br>Date : <span>{{searchFromDateKM | date : 'longDate'}} - {{searchToDateKM | date : 'longDate'}}</span></div>
                                                    <div class = "col-md-4">
                                                        <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" ng-click = "saveInExcel()">
                                                            <i class = "icon-download-alt"></i><span class = "marginLeft5">Excel</span>
                                                        </button>
                        ...
                        <!-- Table-->                           
                           <div class = "col-md-12 col-xs-12 tableWrapper_report" ng-show = "gotSMSResult">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid">
                                <thead class ="tableHeading">
                                    <tr>
                                        <th colspan = "11" class ="tableHeadding_km" style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                            <div class = "row">
                                                <div class = "col-md-4">
                                                </div>
                                                <div class = "col-md-4">
                                                    SMS Report for Date : <span>{{searchFromDateSMS | date : 'longDate'}} - {{searchToDateSMS | date : 'longDate'}}</span>
                                                </div>
                                                <div class = "col-md-4">
                                                    <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" ng-click = "saveInExcel()">
                                                        <i class = "icon-download-alt"></i><span class = "marginLeft5">Excel</span>
                                    ...
                                    <tr>
                                        <th colspan = '10' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                            <div class = "row">
                                                ...
                                                <div class = "col-md-4">                                                    
                                                    Escort Report</br> 
                                                    <span>{{searchFromDateEscort | date : 'longDate'}} - {{searchToDateEscort | date : 'longDate'}}</span>
                                                </div>
                                                <div class = "col-md-4">
                                                    <button class = "btn btn-sm btn-success form-control excelExportButton floatRight" ng-click = "saveInExcel()">
                                                    <i class = "icon-download-alt"></i><span class = "marginLeft5">Excel</span></button>
                       ...
                       <div class = "kmTabContent"><div class = "searchDIVREPORT row marginRow">
                           ...
                           <div id = 'exportTableVDAttendance' class = "col-md-12 col-xs-12 tableWrapper_report" ng-show = "gotVDAttendanceResult">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid">
                                <thead class ="tableHeading">
                                    <tr>
                                        <th colspan = '6' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                            <div class = "row">
                                                <div class = "col-md-4">
                                                </div>
                                                <div class = "col-md-4">                                                    
                       ...
                       <div class = "kmTabContent"><div class = "searchDIVREPORT row marginRow">
                           ...
                           <div id = 'exportTableDriverWH' class = "col-md-12 col-xs-12 tableWrapper_report" ng-show = "gotDriverWHResult">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid">
                                <thead class ="tableHeading">
                                    <tr>
                                        <th colspan = '9' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                            <div class = "row">
                                                <div class = "col-md-4">
                                                </div>
                                                <div class = "col-md-4">
...
<!--      						  		<option value="">-- Select --</option>-->
                           ...
                           <div id = 'exportTableSpeed' class = "col-md-12 col-xs-12 tableWrapper_report" ng-show = "gotSpeedResult">
                            <table class = "reportTable table reportTable_km table-responsive container-fluid">
                                    <thead class ="tableHeading">
                                        <tr>
                                            <th colspan = '14' style = "background-color:rgba(0, 0, 0, 0.46); color: white">
                                                <div class = "row">
                                                    <div class = "col-md-4"></div>
                                                    <div class = "col-md-4">
                                                        Speed Report</br> 
