...
-->
                                     <td  class = 'col-md-1' ng-show = "route.tripType == 'PICKUP'">
                                         {{employee.pickUpTime}}
                                         <button class = "pointer btn btn-danger save_pickUpTime" 
                                              tooltip="Update PickUp Time"
                                              tooltip-placement="top"
                                              tooltip-trigger="mouseenter"
                                              ng-click = "updateEmployeeRequest(route, zone, employee, $index)">
                                             <span>Update</span>
                                         </button>
                                     </td>
                                      <td  class = 'col-md-1' ng-show = "route.tripType == 'DROP'">
                                         {{employee.pickUpTime}}
                                         <button class = "pointer btn btn-danger save_dropSequence" 
                                              tooltip="Update Drop Sequence"
                                              tooltip-placement="top"
                                              tooltip-trigger="mouseenter"
                                              ng-click = "updateEmployeeRequest(route, zone, employee, $index)">
                                             <span>Update</span>
