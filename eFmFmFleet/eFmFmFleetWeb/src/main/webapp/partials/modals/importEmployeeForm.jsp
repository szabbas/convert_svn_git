    ...
    <div class = "row">
        <div class="modal-header modal-header1 col-md-12"> 
            <div class = "row">
                ...
                <div class = "modalHeading col-md-8 floatLeft">Import Employee Data</div>
...
<div class="modal-body modalMainContent">    
 <form class='importEmpForm' id="addinstgroup" action="services/xlUtilityEmployeeUpload/employeeRecord"
