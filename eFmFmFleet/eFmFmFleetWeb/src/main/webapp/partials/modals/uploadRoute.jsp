    ...
    <div class = "row">
        <div class="modal-header modal-header1 col-md-12"> 
            <div class = "row">
                ...
                <div class = "modalHeading col-md-8 floatLeft">Upload Routes</div>
...
<div class="modal-body modalMainContent">    
 <form class='importEmpForm' id="addinstgroup" action="services/xlEmployeeExport/readCreatedRoute"
 ...
 <div class="fileinput fileinput-new input-group " data-provides="fileinput">
     ...
     <div class="modal-footer modalFooter">  
           <button type="button" class="btn btn-info floatLeft" id='imp_stud' ng-click = "uploadFile()">Submit</button>
