...
//            }
        ...
        $scope.setPickDropLocation = function(user){ 
            console.log('address : ' + user.empaddress + 
                  ' latlongi : ' + user.cord + 
...
var editEmployeeCtrl = function($scope, $modalInstance, $state, $http, $timeout, employee, branchId){ 
 ...
 //       alert(employee.employeeLatiLongi);
    ...
    //************************************************************************//
       ...
       var convertToTime = function(newdate){
        ...
        $scope.user = {'employeeId':employee.employeeId,
...
//            }
    ...
    //***************************************************************************************//
        ...
        $scope.updateEmployee = function(updatedEmployee){  
            if(($scope.user.empaddress == employee.employeeAddress) && ($scope.user.name == employee.employeeName) && ($scope.user.employeeDesignation == employee.employeeDesignation) && ($scope.user.number == employee.mobileNumber) && ($scope.user.email == employee.emailId) && (updatedEmployee.cords==undefined)) {
                ...
                if(updatedEmployee.empaddress != employee.employeeAddress && updatedEmployee.cords==undefined ){
                    $scope.showalertMessageModal("You have change your address, Please enter the same address in the Geo Location Text box.", "");
                }
                else{                    
                    var dataObj = {
                         eFmFmClientBranchPO:{branchId:branchId},
