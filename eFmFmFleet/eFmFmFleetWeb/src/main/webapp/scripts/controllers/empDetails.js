...
//            }
 ...
 //           alert($scope.user.empaddress+"new add"+employee.empaddress);
 //           alert(updatedEmployee.number + " : " + updatedEmployee.email + " : "+profileId );
            if(($scope.user.address == employee.address) && ($scope.user.name == employee.employeeName) && ($scope.user.employeeDesignation == employee.employeeDesignation) && ($scope.user.number == employee.mobileNumber) && ($scope.user.email == employee.emailId)) {
