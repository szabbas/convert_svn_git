...
//                      alert("hiii");
       ...
       //Update Pickup time or Drop Sequence from Routing page
       $scope.updateEmployeeRequest = function(route, zone, employee, employeeIndex){
    	  
           var routeIndex = _.findIndex($scope.routesData, { routeId: route.routeId });
           alert("reqId"+employee.requestId);
           alert(route.routeId);
//           if (confirm("Are you sure you want to delete this row?") == true) {       
           $confirm({text: 'Are you sure you want update the request?', title: 'Delete Confirmation', ok: 'Yes', cancel: 'No'})
        .then(function() {  
               var dataObj = {
            		   branchId:branchId,
                ...
                $http.post('services/zones//',dataObj).
                success(function(data, status, headers, config) {                    
                    $timeout(function () {
...
//                        alert($scope.routesData[routeIndex].empDetails.length);
                        $scope.showalertMessage("Request Updated successfully, please close the bucket.", "");
       ...
       //Delete a request from  allocation or service mapping page
