    ...
    <div class = "row">
        <div class="modal-header modal-header1 col-md-12"> 
            <div class = "row">
                ...
                <div class = "modalHeading col-md-10 floatLeft">Vehicle Available For Trip</div>
...
<!--              <th>Trip Type</th>-->
        ...
        <tbody ng-show = "vehicleAvailableData.length==0">
                                    <tr>
                                        <td colspan = '7'>
        ...
        <tbody ng-show = "vehicleAvailableData.length>0">
            <tr ng-repeat = "vehicle in vehicleAvailableData | filter: search">
