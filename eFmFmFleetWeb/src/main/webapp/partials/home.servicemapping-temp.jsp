<div class = "serviceMappingTemplate container-fluid">
 <div class = "row">
        <div class = "col-md-12 col-xs-12 heading1">            
            <span class = "col-md-12 col-xs-12">Routing And Cab Allocation</span> 
                              ...
                              <input ng-model="search.input"
                               ...
                               <span class="input-group-btn">
                                   <button class="btn btn-info" 
                                           ng-click="searchEmployee(search.input)" >
...
<!--                    </div>   -->
 ...
 <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  <div class="panel panel-default accordianPanel_serviceMapping" ng-repeat = "zone in zoneData">
    ...
    <div class="panel-heading panelHeading_serviceMapping" 
         role="tab" 
         id="headingOne">
    ...
    <div id="collapse{{zone.routeId}}" 
      ...
      <div class="panel-body accorMainContent"> 
        <div class = "routesBucket route{{zone.routeId}}{{route.routeId}}" 
             ng-repeat = "route in routesData | filter: {routeName : zone.routeName}"
          ...
          <div class = "row overflowAuto">
            ...
            <div class = "col-md-3 col-xs-6 customTabs">
                ...
                <span class = "floatRight pointer" 
                    ...
                    <img src = "images/portlet-remove-icon-white.png"></span>
              </div>
<!--
...
<!--
                             <input type = "button" 
                                    class = "floatRight btn btn-danger1 btn-xs manuallyStartTripButton_serviceMapping"                                      
                                    value= "{{route.tripStatus == 'Started' ? 'Manually Trip End' : 'Manually Trip Start'}}"                                   
                                    ng-click = "manualTripStart(route, zone)">
-->
...
<!--
                               <input type = "button" 
                                      class = "floatRight btn btn-primary1 btn-xs"                          
                                      value = "Optimize Buckets" 
                                      ng-click = "optimizeBucket(route, zone,$event)"
                                      ng-class = "{disabled: route.tripType=='PICKUP'||route.optimizeBucketClicked || route.tripStatus == 'Started'}">
-->
                               <input type = "button" 
        ...
        <div class = "col-md-12 col-xs-12 heading1">            
            ...
            <div class = "col-md-12 col-xs-12 mainTabDiv_serviceMapping">
                <div class = 'row'>
                    ...
                    <div class = 'accordianPanel_serviceMapping'></div>
                
                
  <accordion close-others="false">
    <accordion-group heading="{{zone.routeName}}" ng-repeat="zone in zoneData" ng-click = 'getRoutes(zone)'>
        
    <div id="collapse{{zone.routeId}}" 
         class="accordionContent_serviceMapping">
